...
//     http://crbug.com/341805. This may break if pthread_cond objects are
...
//   reporthread_leaks=0 - do not report unjoined threads at the end of
...
const char kTsanDefaultOptions[] =
    ...
    "reporthread_leaks=0 print_suppressions=1 history_size=7 "
    "strict_memcmp=0 strip_path_prefix=/../../ ";

SANITIZER_HOOK_ATTRIBUTE const char *_san_default_options() {
  return kTsanDefaultOptions;
}

extern char kTSanDefaultSuppressions[];

SANITIZER_HOOK_ATTRIBUTE const char *_san_default_suppressions() {
